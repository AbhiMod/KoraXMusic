...
async def get_thumb(videoid):
    ...
    try:
        ...
        font_size = 40
        font = ImageFont.truetype("KoraMusic/assets/font2.ttf", font_size)
        font2_size = 70
        font2 = ImageFont.truetype("KoraMusic/assets/font2.ttf", font2_size)
        arial = ImageFont.truetype("KoraMusic/assets/font2.ttf", 30)
        name_font = ImageFont.truetype("KoraMusic/assets/font.ttf", 40)
        
        para = textwrap.wrap(clear(title), width=32)  # Corrected title clearing
        j = 0
        draw.text(
            (6, 6), f"{BOT_USERNAME}", fill="Yellow", font=name_font
        )
        draw.text(
            (600, 200),
            f"NOW PLAYING",
